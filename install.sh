...
curl https://raw.githubusercontent.com/tonyOehme/dotfiles/main/vscoce_settings_mac.json > ~/Library/Application Support/Code/User/settings.json
curl https://raw.githubusercontent.com/tonyOehme/dotfiles/main/vscoce_settings_mac.json > ~/Library/Application Support/Code/User/keybindings.json
source ~/.zshrc
